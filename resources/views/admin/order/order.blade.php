                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tracking
                                        Number
                                    </th>
                            ...
                            <tbody>
                                @foreach ($order as $ord)
                                    <tr>
                                        <td>
                                            <div class="px-3 py-1">
                                                <h6 class="mb-0 text-sm">{{ date('d-m-Y', strtotime($ord->created_at)) }}</h6>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="px-3 py-1">
                                                <h6 class="mb-0 text-sm">{{ $ord->tracking_no }}</h6>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="px-1 py-1">
                                                <h6 class="text-sm">{{ $ord->total_price }}</h6>
                                            </div>
                                        </td>
                                        <td class="align-middle text-center">
                                            <a href="{{ url('order-view') }}"><button
